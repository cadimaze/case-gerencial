...
const VCHAR = {
  ...
  backend() {
    ...
    c.prop = `
      ...
      <!-- caneca de café -->
      <rect x="63" y="84" width="10" height="11" rx="2.5" fill="#f5f5f5" stroke="#c4c4c4" stroke-width="1"/>
      <rect x="63" y="84" width="10" height="3.5" fill="#6f4a2f"/>
      <path d="M73 86 q5 0.5 5 4.5 t-5 3.5" fill="none" stroke="#c4c4c4" stroke-width="1.6"/>
      <path d="M66 80 q-1.5 -2 0 -4" stroke="#cfd6dd" stroke-width="1.3" fill="none" stroke-linecap="round" opacity="0.8"/>
      <path d="M70 80 q1.5 -2 0 -4" stroke="#cfd6dd" stroke-width="1.3" fill="none" stroke-linecap="round" opacity="0.8"/>`;
    c.beard = `
